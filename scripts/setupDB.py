...
insert into pc_configuration (config_key, config_value) values ('FILTER-OVERRIDE', 'ON'); # only in automatic mode - if solar has enough heat we can heat also outside the filter schedule
...
insert into pc_sensors (sensor_location_id, sensor_transmit_type, sensor_model, sensor_channel, sensor_address, temperatureunit) values ('FROM-POOL', '1WIRE', '', '', '28-00000b54e775', 'C');
insert into pc_sensors (sensor_location_id, sensor_transmit_type, sensor_model, sensor_channel, sensor_address, temperatureunit) values ('TO-POOL', '1WIRE', '', '', '28-00000b54ac94', 'C');
